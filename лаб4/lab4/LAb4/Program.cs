...
namespace LAb4
{
    class Program
    {
        public struct Product
        {
            ...
            public static double GetTotalPriceInUAH()
            {
                double totalSum = (double)ent[0].Quantity * ent[0].Price;
                return totalSum;
            }
            public static double GetTotalWeight()
            {
                double totalWeight = (double)ent[0].Quantity * ent[0].Weight;
                return totalWeight;
            }
            ...
            public static string GetProductsInfoMax()
            {
                double max = -1e7;
                int k = 0;
            ...
            public static string GetProductsInfoMin()
            {
                double min = 1e7;
                int k = 0;
                for (int i = 0; i < ent.Length; i++)
                ...
                switch (choose)
                {
                    ...
                    case 3:
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("{0}", Product.GetProductsInfoMax());
                        }
                        Console.ReadKey();
                        break;
                    case 4:
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("{0}", Product.GetProductsInfoMin());
